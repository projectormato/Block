...
/**
 * <p>
 * Actorが壊れたときのアニメーションをする。通常の画像から爆発した画像に切り替わり、その後フェードアウトしていくアニメーションが表示される。</p>
 *
 * <p>
 * 注意<br>
 * <ul>
 * <li>このアニメーションが終了するまで画面切り替えが行われない。</li>
 * <li>Worldに追加するとすぐにアニメーションが開始される。</li>
 * <li>アニメーションが終了したら、このActorは直ちに削除される。</li>
 * </ul></p>
 *
 * <p>
 * 使用方法:<br>
 * BaseActor.onDied()からこのクラスのサブクラスをWorldに追加し、自身はWorldから削除、または透明にする。</p>
 *
 * @author yuuki0xff
 */
